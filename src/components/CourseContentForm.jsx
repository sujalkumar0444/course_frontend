...
<section className="bg-white w-full">
  <div className="lg:grid lg:min-h-screen lg:grid-cols-6">
    <aside className="relative block h-16 lg:order-last lg:col-span-5 lg:h-full xl:col-span-6 lg:px-16 lg:py-12">
      <h1>PreView</h1>
    <div
    >{HTMLReactParser(content)}</div>
      {console.log(content)}
    </aside>
      ...
      <div className="max-w-xl lg:max-w-3xl">
        ...
        <div action="#" className="mt-8 grid grid-cols-6 gap-6">
          ...
          <div className="col-span-6">
            <label htmlFor="Email" className="block text-sm font-medium text-gray-700"> _id </label>
